...
async def get_page_tenders(
    page: int = 1,
    page_size: int = 10,
    object_group_id: Optional[int] = None, object_type_id: Optional[int] = None,
    service_type_ids: Optional[List[int]] = None, service_group_ids: Optional[List[int]] = None,
    floor_space_from: Optional[int] = None, floor_space_to: Optional[int] = None,
